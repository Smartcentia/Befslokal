                            ...
                            <div className="mt-8 pt-8 border-t border-border">
                                ...
                                <div className="bg-surface/50 p-4 rounded-lg flex items-center justify-between group cursor-pointer hover:bg-white/10 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="font-bold text-foreground">{contract.property?.address || "Adresse ikke tilgjengelig"}</div>
                                            <div className="font-bold text-foreground">{contract.property?.address}</div>

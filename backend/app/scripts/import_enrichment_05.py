...
def parse_line(line: str) -> Optional[Dict[str, Any]]:
    ...
    # Amount is at the end, handles negative and comma
...
async def update_database(file_path: str):
    ...
    async with SessionLocal() as db:
        ...
        for raw_key, transactions in by_property.items():
            ...
            # Special handling for Region Nord addresses/names if needed
            # But general fuzzy match has worked well
        ...
        await db.commit()
        print(f"Import Summary for 05.txt:")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python import_enrichment_05.py <file_path>")
    else:
